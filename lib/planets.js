...
const generatePlanetOutside = (planet, speedFactor = 1) => {
  ...
  return { position, scale, animation, visible: false };
};

const generatePlanetInside = (planet, speedFactor = 1) => {
...
export const generatePlanet = (planet, speedFactor) => ({
